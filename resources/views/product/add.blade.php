                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="{{url('userarrange')}}">Kullanıcı Düzenleme</a> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="{{url('categoryarrange')}}">Kategori Düzenleme</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div id="collapseFour" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="{{url('productarrange')}}">Ürün Düzenleme</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
