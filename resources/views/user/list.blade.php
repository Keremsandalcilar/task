...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <div class="col-md-12">
            <div style="font-size: 20px"> Kullanıcı Listesi </div>
                        ...
                        <table class="table table-striped custab">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->username}}</td>
                                    <td>{{$user->password}}</td>
                                    <td class="text-center"><a class='btn btn-info btn-xs' href="{{ url('useredit') }}"><span
                                                class="glyphicon glyphicon-edit"></span> Düzenle</a> <a href="{{ url('userdelete') }}"
