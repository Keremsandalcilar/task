...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <div class="col-md-12">
                <div style="font-size: 20px"> Kategori Listesi </div>
                            ...
                            <table class="table table-striped custab">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a class='btn btn-info btn-xs'
                                            href="{{ url('categoryedit') }}"><span
                                                class="glyphicon glyphicon-edit"></span> Düzenle</a> <a
                                            href="{{ url('categorydelete') }}" class="btn btn-danger btn-xs"><span
